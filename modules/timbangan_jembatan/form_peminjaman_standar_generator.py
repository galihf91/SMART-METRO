...
# =========================================================
def generate_form_peminjaman_standar_pdf(
    data,
    filename,
    ...
    # =====================================================
    # DATA ALAT STANDAR DARI INPUT APLIKASI
    # =====================================================
        ...
        daftar_alat = [
            {
                "jenis_alat": "BIDUR",
                "nomor_seri": "",
                "jumlah": str(data.get("jumlah_bidur", 100)),
                "lama_peminjaman": "1 Hari"
            },
            {
                "jenis_alat": "AT 10 kg",
                "nomor_seri": "",
                "jumlah": str(data.get("jumlah_at_10kg", 1)),
                "lama_peminjaman": "1 Hari"
            },
            {
                "jenis_alat": "AT 5 kg",
                "nomor_seri": "",
                "jumlah": str(data.get("jumlah_at_5kg", 1)),
                "lama_peminjaman": "1 Hari"
            },
            {
                "jenis_alat": "AT 2 kg",
                "nomor_seri": "",
                "jumlah": str(data.get("jumlah_at_2kg", 2)),
                "lama_peminjaman": "1 Hari"
            },
            {
                "jenis_alat": "AT 1 kg",
                "nomor_seri": "",
                "jumlah": str(data.get("jumlah_at_1kg", 1)),
                "lama_peminjaman": "1 Hari"
            }
        ]
    if data.get("tambahkan_alat_standar", False):
        jenis_tambahan = data.get(
        ...
        if jenis_tambahan:
            daftar_alat.append(
                {
                    "jenis_alat": jenis_tambahan,
                    "nomor_seri": "",
                    "jumlah": f"{jumlah_tambahan} Set",
                    "lama_peminjaman": "1 Hari"
                }
            )
    
    if data.get("gunakan_at_m1", False):
        daftar_alat.append(
            {
                "jenis_alat": "AT M1",
                "nomor_seri": "",
                "jumlah": f"{data.get('jumlah_at_m1', 1)} Set",
                "lama_peminjaman": "1 Hari"
            }
        )

    if data.get("gunakan_at_f2", False):
        daftar_alat.append(
            {
                "jenis_alat": "AT F2",
                "nomor_seri": "",
                "jumlah": f"{data.get('jumlah_at_f2', 1)} Set",
                "lama_peminjaman": "1 Hari"
            }
        )
    # =====================================================
